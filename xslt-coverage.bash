...
[[ -f ${SAXON_HOME}/saxon.jar ]] || die "Set SAXON_HOME to be a directory which contains a file named saxon.jar. Can be downloeded here (need to rename it): https://sourceforge.net/projects/saxon/files/Saxon-HE/9.9/SaxonHE9-9-1-8J.zip/download"
...
xslt_coverage() {
  ...
  java \
    ...
    -cp "${SAXON_HOME}"/saxon.jar:"${XSPEC_HOME}"/java/ \
